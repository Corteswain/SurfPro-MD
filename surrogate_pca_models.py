...
Usage:
  python surrogate_pca_models.py           # 30 Optuna trials (full)
  python surrogate_pca_models.py --quick   # 10 trials (fast test)
"""
...
def optimise(df, feature_cols, target_col, split):
    ...
    best  = xgb.XGBRegressor(**study.best_params, random_state=72)
    best.fit(Xtr_sc, ytr)
